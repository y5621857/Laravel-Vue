...
@section('content')
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a href="javascript:;">编辑视频</a></li>
  </ul>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" rows="5" name="introduce" required>{{$lesson->introduce}}</textarea>
          </div>
        </div>
        <div class="form-group">
